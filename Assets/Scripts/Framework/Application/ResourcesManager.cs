...
public class ResourcesManager : SingletonFactory<ResourcesManager>
{
    ...
    public GameObject LoadSpine(string model)
    {
        string path = UtilTools.combine(Role, model);
        return Resources.Load<GameObject>(path);
    }
    ...
    public static Sprite GetPlayerPicture(string name)
    {
       // name = "crcheng";
        string path = UtilTools.combine("Players/", name);
